                    ...
                    <section key={categoryName} className="animate-slide-up">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                        {displayItems.map((item) => {
                          ...
                          // Trusted Helpers: only Call, no Chat
                          return (
                            <article
                              key={item.id}
                            ...
                            >
                              ...
                              <div className="px-2 pb-2 pt-0" onClick={(e) => e.stopPropagation()}>
                                <a href={`tel:${item.phone}`} className="block w-full py-2 rounded-lg bg-brand-600 text-white text-center text-[11px] font-semibold hover:bg-brand-700 transition-all flex items-center justify-center gap-1.5">
