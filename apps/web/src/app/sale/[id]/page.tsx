          ...
          <div className="space-y-6">
            ...
            {item.phone && (
              <div className="flex flex-wrap gap-2">
                <a
                  href={`tel:${item.phone}`}
                  className="flex-1 min-w-[120px] py-4 rounded-xl bg-brand-600 text-white text-center font-semibold hover:bg-brand-700 transition flex items-center justify-center gap-2"
                >
                ...
                <a
                  ...
                  className="flex-1 min-w-[120px] py-4 rounded-xl bg-emerald-600 text-white text-center font-semibold hover:bg-emerald-700 transition flex items-center justify-center gap-2"
                >
                ...
                <ShareButton
                  title={item.title}
                  description={item.area_text ? `📍 ${item.area_text}` : undefined}
                  url={`/sale/${item.id}`}
                  className="shrink-0"
                  size="md"
                  label="Share"
