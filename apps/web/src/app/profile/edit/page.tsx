    ...
    <div className="min-h-screen bg-[#f8faf9]">
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-xs text-stone-500 mt-1">Shown on Yaari & profile</p>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-stone-500 mb-2">
            ...
            <Link href="/chat/interests" className="text-brand-600 font-medium hover:underline">Yaari</Link>.
          </p>
          <div className="flex flex-wrap gap-2">
